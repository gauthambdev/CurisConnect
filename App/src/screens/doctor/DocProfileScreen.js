...
const DocProfileScreen = ({ navigation }) => {
  ...
  const [speciality, setSpeciality] = useState({ value: '', error: '' });
      ...
      try {
        ...
        if (user) {
          ...
          if (userDoc.exists()) {
            ...
            setHospital({ value: userData.hospital || '', error: '' });
            setSpeciality({ value: userData.speciality || '', error: '' });
        ...
        <ScrollView contentContainerStyle={styles.scrollViewContainer}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setHospital({ value: text, error: '' })}
              error={!!hospital.error}
              errorText={hospital.error}
              editable={isEditing}
            />
            <TextInput
              label="Speciality"
              ...
              onChangeText={(text) => setSpeciality({ value: text, error: '' })}
              error={!!speciality.error}
              errorText={speciality.error}
              editable={isEditing}
            />
          </View>
