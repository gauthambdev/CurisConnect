...
export default function RegisterScreen({ navigation }) {
  ...
  const onSignUpPressed = async () => {
    ...
    const contactNumberError = numberValidator(contactNumber.value);
    ...
    <Background>
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
          ...
          <TextInput label="Contact Number" returnKeyType="next" value={contactNumber.value} onChangeText={(text) => setContactNumber({ value: text, error: '' })} error={!!contactNumber.error} errorText={contactNumber.error} keyboardType="phone-pad" />
